...
> ★ **담당 채널 배정·새 작품 붙이기·스케줄러 걸기는 `SCENE_LOOP_OPERATIONS.md` 가 정본이다**(2026-07-28).
> 이 문서는 그 앞 단계(도구·레포·venv·.env·rclone)까지만 다룬다.

- 채널·작품은 머신/운영마다 다름 — **`config/channels.json`이 채널↔작품 매핑의 단일 소스**, 어느 머신이 어느 채널을 맡는지는 `config/assignments.json`
...
## 10. 채널–작품 매핑 (2026-07-23 스냅샷 — ⚠️ 낡음)
